...
import { type Dispatch, FormattedMessage, SelectLang } from 'umi';
import { connect } from 'dva';
import { Divider, Typography } from 'antd';
import { ProdType } from '@/models/products';
...
const Products: React.FC<InfoProps> = ({ message, dispatch }) => {
  useEffect(() => {
    dispatch({
      type: 'products/fetchMessage',
    });
  }, []);
...
const mapStateToProps = ({ products }: { products: ProdType }) => {
  return { message: products.message };
};
